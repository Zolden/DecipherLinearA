...
ROWS = [
    ...
    ('Пломбы №3: повторяемость (§DN)', 0.385, 0.129, 0.073, 24, 10000,
     'roundels2.log'),
    ('D-серии №4: rep2−rep1=+0.206 (§DW)', 0.778, 0.572, None, 0, 10000,
     'dseries_prereg4.log (нуль обмена)'),
    ('Fp №6: адресаты 0.481 vs D-13 (§EE)', 0.481, 0.116, 0.123, 43, 10000,
     'fp_prereg6.log (подвыборки)'),
    ('Жанр LB: TTR1−TTR2=+0.236 (§DU)', 0.56, 0.32, None, 0, 10000,
     'damos_formular.log'),
